...
const TopPlatform = () => {
  return (
    <section className="mx-5 w-[97%] xl:w-[40%] bg-white dark:bg-gray-600 border-[#EDF2F7] dark:border-[#3d6185] border-[1px] xl:h-[400px] p-5 rounded-[14px] flex flex-col gap-2 overflow-y-auto">
