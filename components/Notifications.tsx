...
const Notifications = () => {
  return (
    <DropdownMenu>
      <DropdownMenuTrigger className="border-[0.4px] border-[#78828A] dark:border-[#333a40] bg-white dark:bg-slate-900 rounded-full p-[7px] w-fit h-fit flex items-center">
